...
bool operator==(const Stats& lhs, const Stats& rhs) {
  return (lhs.innings == rhs.innings) && (lhs.bat_avg == rhs.bat_avg) &&
         (lhs.bat_sr == rhs.bat_sr) && (lhs.balls_bowled == rhs.balls_bowled) &&
...
string Player::get_initials() const { return initials; }
...
string Player::get_last_name() const { return last_name; }

// Return full first and last name, e.g. John Smith
string Player::get_full_name() const { return first_name + " " + last_name; }

Stats Player::get_stats() const { return player_stats; }

// Specific getters for stats
int Player::get_innings() const { return player_stats.innings; }

double Player::get_bat_avg() const { return player_stats.bat_avg; }

double Player::get_bat_sr() const { return player_stats.bat_sr; }

int Player::get_balls_bowled() const { return player_stats.balls_bowled; }

double Player::get_bowl_avg() const { return player_stats.bowl_avg; }

double Player::get_bowl_sr() const { return player_stats.bowl_sr; }
...
bool operator==(const Player& lhs, const Player& rhs) {
  return (lhs.first_name == rhs.first_name) &&
         (lhs.last_name == rhs.last_name) && (lhs.initials == rhs.initials) &&
...
// template Player** sort_array<int>(Player** list, int len, int
// (Player::*sort_val)() const);
template Player** sort_array<double>(Player** list, int len,
                                     double (Player::*sort_val)() const);
// template Player** sort_array<std::string>(Player** list, int len, std::string
// (Player::*sort_val)() const);

bool operator==(const Team& lhs, const Team& rhs) {
  bool partial = (lhs.name == rhs.name) && (lhs.i_captain == rhs.i_captain) &&
                 (lhs.i_wk == rhs.i_wk) && (lhs.i_bowl1 == rhs.i_bowl1) &&
