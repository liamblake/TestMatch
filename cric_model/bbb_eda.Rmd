...
```{r}
bbb %>% ggplot(aes(bat_team_total_runs)) + geom_histogram(bins = 50, fill = "maroon", colour = "black")
```

```{r}
bbb %>% ggplot(aes(bowl_team_total_runs)) + geom_histogram(bins = 50, fill = "maroon", colour = "black")
```

```{r}
bbb %>% ggplot(aes(bat_team_total_wkts)) + geom_histogram(bins = 20, fill = "maroon", colour = "black")
```

```{r}
bbb %>% ggplot(aes(bowl_team_total_wkts)) + geom_histogram(bins = 20, fill = "maroon", colour = "black")
```
