...
#define private public // This is a hack and immensely evil, but lets me test private methods easily
#include "Player.h"
#include "Cards.h"
...
BOOST_AUTO_TEST_CASE(testclass_innings) {
	...
	BOOST_TEST(inns.striker->get_player_ptr() == &a1 | inns.striker->get_player_ptr() == &a2);
	BOOST_TEST(inns.nonstriker->get_player_ptr() == &a1 | inns.nonstriker->get_player_ptr() == &a2);
