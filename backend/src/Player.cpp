...
//
//OverCount::OverCount(const OverCount& oc) {
//	overs = oc.overs;
//	balls = oc.balls;
//}
//
//
//int OverCount::as_balls() {
//	return 6 * overs + balls;
//}
//
...
//	stream << std::fixed << std::setprecision(1) << float(*this);
//	return stream.str();
//}
//
//OverCount::operator float() const {
//	int tmp = 10*overs + balls;
//
//	// Integer casting prevents overflow
//	return (float) tmp / 10;
//}
//
//
